...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-[#EFF7FF] to-[#D6EAFF] dark:from-card dark:to-background transition-colors duration-300">
