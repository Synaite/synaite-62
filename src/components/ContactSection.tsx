  ...
  return <section className="py-20 px-6 md:px-12 lg:px-24 bg-slate-950">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[#B0B5BF] max-w-2xl text-lg text-center mx-0">We’re passionate about exploring how AI can transform the way businesses operate. Whether you're an investor, a fellow founder, or just curious about the future of work — we’d love to connect.
