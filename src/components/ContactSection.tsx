...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 px-6 md:px-12 lg:px-24 bg-card transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Phone Card */}
          <div className="bg-gradient-to-b from-card to-background rounded-xl p-8 shadow-lg border border-primary/20 hover:border-primary/40 transition-all hover:shadow-primary/10 hover:shadow-lg">
