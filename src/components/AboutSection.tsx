...
const AboutSection = () => {
  return <section className="px-6 md:px-12 lg:px-24 bg-gradient-to-b from-[#F6FBFF] to-[#D6EFFF] dark:from-background dark:to-card transition-colors duration-300 py-[60px]">
